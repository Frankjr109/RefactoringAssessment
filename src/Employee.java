...
/*
 * We could have an Employee class which consists of the attributes
 * Then create a person class. The person class attributes will consist of
 * pps number, firstname, surname and gender.
 */
...
public class Employee{
	...
	//Addition of person object to the Employee class 
	Person aPerson;
